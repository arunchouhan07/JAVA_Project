...
<nav class="navbar " id="new" >
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="displayallproduct.jsp" id="head">All Products</a></li>
            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <%
                            ...
                            List<Product> lst = pdao.displayProducts();
                    ...
                    %>
                    	...
                    	<div class="col-lg-4"> 
      						<div class="panel panel-primary">
        						...
        						<div class="panel-body"><%=qs.getProductname()%><img src="Homepage/css/display.jpg" class="img-responsive" style="height:195px; width:100%" alt="Image"></div>
