		...
		<div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    ...
                    List<Order> lst = daoImpl.getAllOrdersForUser(
                    		u.getUserid());
                    ...
                    <tr>
                        ...
                        <td><%=o.isAccepted()%></td>
                        <td><%=o.isCancelled()%></td>
            			<td><button id="btnRaise" class="btn btn-danger" onclick="openMyDialog(<%=o.getOrderid()%>)">
            			Update Address
            			</button>
            			</td>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <table class="table table-hover">
        ...
        <tr>
            <td><button id="btnRaise" class="btn btn-danger" onclick="updateAddress()">
            		Update Address
            	</button>
            </td>
        </tr>
									...
									function getProductResponse() {
										if (request.readyState == 4) {
											...
											if (val.trim() == "success") {
												...
												alert("Unable to update address Try Again");
